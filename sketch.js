...
if(score==25){
  ...
  text("superb",windowWidth/2,windowHeight/2);
}if(score==50){
  text("halfway done",windowWidth/2,windowHeight/2);
}
if(score==75){
  text("small peak is left",windowWidth/2,windowHeight/2);
}
